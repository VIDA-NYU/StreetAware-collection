...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
USAGE:
  python sync_videos.py <data_path> [--output-dir OUTPUT_DIR] [--threshold THRESHOLD] [--max-frames MAX_FRAMES] [--fps FPS] [--rotation ROTATION]
...
OPTIONS:
  ...
  --rotation          Rotation angle (0, 90, 180, 270; default: 0)
    ...
    if args.rotation not in [0, 90, 180, 270]:
        ...
        return
    build_mosaic_and_individual_videos(args.data_path, args.output_dir, args.threshold, args.max_frames, args.fps, args.rotation)
